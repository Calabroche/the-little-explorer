      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        <div style={{ order: 2, display: 'flex', flexDirection: 'column', gap: 0, minWidth: 0 }}>
          <div style={mapFull ? mapFullStyle : mapCardStyle}>
            ...
            {/* Fullscreen-only bottom overlay: route summary + elevation
                profile. In fullscreen the stats bar and elevation card that
                live under the map are hidden behind the overlay, so we surface
                both here. Hovering the profile shows altitude / slope /
                cumulative D+ AND moves the synced marker on the route above —
                exactly the normal-view behaviour (onHover → hoverEleIdx →
                hoverPos marker in the MapContainer). */}
